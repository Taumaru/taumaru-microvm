...
pub use microvm::{
    ...
    MicroVmCreationResult, MicroVmStartResult, MicroVmStopResult, MicroVmSummary,
    NetworkConfiguration, NetworkConfigurationResult, NetworkResource, RunningMicroVm,
